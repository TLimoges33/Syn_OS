...
# Configuration
KERNEL_PATH="${PROJECT_ROOT}/target/x86_64-syn_os/debug/bootimage-kernel.bin"
...
analyze_bootloader_handoff() {
    ...
    grep -r "bootloader" ${PROJECT_ROOT}/src/kernel/Cargo.toml || echo "Bootloader version info not found"
