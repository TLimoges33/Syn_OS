...
class SecurityError(Exception):
    """Custom security exception for backup operations"""
    pass
...
class ConsciousnessBackup:
    ...
    async def restore_backup(self, backup_id: str) -> bool:
        ...
        try:
            ...
            # Deserialize consciousness state using safe JSON instead of pickle
            import json
            try:
    ...
    async def verify_backup(self, backup_id: str) -> bool:
        ...
        try:
            ...
            try:
                ...
                # Try to deserialize data using safe JSON instead of pickle
                import json
                try:
                    # Try JSON first (safer)
                    restored_data = json.loads(backup_data.decode('utf-8'))
