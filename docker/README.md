...
4. **learning-analytics** - Educational progress tracking
   - Learning velocity analysis
   - Breakthrough detection
   - Dashboard on port 6000
   - API on port 6001

5. **consciousness-db** - PostgreSQL database
   - Time-series consciousness data
   - User profiles and sessions
   - Educational analytics
   - Port 5432

6. **consciousness-cache** - Redis cache
...
7. **educational-gateway** - Nginx reverse proxy
   - SSL termination
   - Load balancing
   - Rate limiting
   - Ports 80/443

8. **qemu-service** - Virtual machine testing
