...
def test_jwt_auth():
    ...
    try:
        ...
        token = jwt_manager.create_access_token("test_user", ["admin"])
...
def test_input_validator():
    ...
    try:
        ...
        result = validator.validate_input(malicious_input, "text")
        ...
        result = validator.validate_input(xss_input, "text")
        if not result.is_valid:
        ...
        result = validator.validate_input(valid_email, "email")
        if result.is_valid:
