...
class ConsciousnessSystem:
    ...
    async def start(self):
        ...
        try:
            ...
            if self.consciousness_core:
                tasks.append(asyncio.create_task(self.consciousness_core.run()))
    ...
    async def _health_check_server(self):
        ...
        async def health_check(request):
            ...
            if self.consciousness_core:
                status['consciousness_state'] = self.consciousness_core.get_state_summary()
        ...
        async def metrics(request):
            ...
            if self.consciousness_core:
                metrics_data['consciousness'] = self.consciousness_core.get_metrics()
            
            if self.event_bus:
                metrics_data['events'] = self.event_bus.get_metrics()
