//! VGA Buffer Module
//!
//! Provides text output through the VGA buffer
...
/// Full VGA color byte with foreground and background
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
#[repr(transparent)]
struct ColorCode(u8);
...
/// VGA text character with color information
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
#[repr(C)]
struct ScreenChar {
    ascii_character: u8,
...
// Make ScreenChar Deref and DerefMut compatible for Volatile
...
/// Print and println macros are now defined in lib.rs
/// Keeping the _print implementation for those macros to use
...
pub fn _print(args: fmt::Arguments) {
    ...
    interrupts::without_interrupts(|| {
        // Ignore write errors - VGA printing should never panic the kernel
