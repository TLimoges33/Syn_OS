...
impl IPCManager {
    ...
    pub fn detect_deadlock(&mut self, _pid: u64, _requested_resource: IPCId) -> bool {
        // Simplified deadlock detection
        // In real implementation, would use wait-for graph
        if self.stats.active_semaphores > 10 {
