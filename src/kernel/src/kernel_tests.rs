...
use crate::consciousness_education_demo;
use alloc::vec::Vec;
...
impl KernelTestSuite {
    ...
    pub fn run_all_tests(&mut self) {
        ...
        self.test_consciousness_education();
    ...
    fn test_consciousness_education(&mut self) {
        ...
        consciousness_education_demo::quick_consciousness_demo();
