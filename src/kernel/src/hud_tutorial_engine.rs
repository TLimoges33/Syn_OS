...
pub struct HUDTutorialEngine {
    ...
    tutorial_library: CybersecurityTutorialLibrary,
    ...
    fn create_hardware_tutorial_steps(&self) -> Vec<TutorialStep> {
        vec![
            TutorialStep {
                ...
                validation: StepValidation::CommandOutput("CPU Vendor:".to_string()),
                context_help: vec![
                    ContextHelp {
            ...
            TutorialStep {
                ...
                validation: StepValidation::CommandOutput("Memory Controller:".to_string()),
                context_help: vec![],
            },
        ]
    }
