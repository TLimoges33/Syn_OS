...
impl CpuState {
    ...
    pub fn new_user(entry_point: u64, stack_pointer: u64, security_ctx: SecurityContext) -> Result<Self, ContextSwitchError> {
    ...
    pub fn validate(&self) -> Result<(), ContextSwitchError> {
        ...
        if self.rflags & 0xFFC38028 != 0 {  // Reserved bits must be zero
            return Err(ContextSwitchError::InvalidCpuState);
        }
...
impl SafeContextSwitcher {
    ...
    pub fn new() -> Result<Self, ContextSwitchError> {
        ...
        let emergency_stack = NonNull::new(emergency_stack)
            .ok_or(ContextSwitchError::NullPointer)?;
    ...
    pub fn context_switch(
        ...
        self.pre_switch_validation(current_state, next_state, security_ctx)?;
        ...
        // Security checks
        self.security_validator.validate_transition(current_state, next_state, security_ctx)?;
    ...
    fn pre_switch_validation(
        ...
        // Validate pointers
        if (next_state as *const CpuState).is_null() {
            return Err(ContextSwitchError::NullPointer);
        }
    ...
    pub fn get_stats(&self) -> ContextSwitchStats {
        ...
        ContextSwitchStats {
            ...
            average_switch_time: if switches > 0 { total_time / switches } else { 0 },
...
mod tests {
    ...
    fn test_corrupted_state_detection() {
        ...
        assert_eq!(state.validate().unwrap_err(), ContextSwitchError::CorruptedStack);
    }
